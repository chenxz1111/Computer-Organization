...
parameter BASE_RAM_INIT_FILE = "F:\\rv\\asmcode\\lab5.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "F:\\rv\\asmcode\\picture.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
